...
document.addEventListener("DOMContentLoaded", function () {
    document.body.addEventListener("change", function (e) {
        if (e.target.classList.contains("portion-checkbox")) {
            const priceInput = e.target.closest(".form-check").querySelector(".portion-price");
...
function addPortion(selectElement) {
    ...
    if (document.querySelector(`input[name^="dishes[${index}][portions]"][value="${portionId}"]`)) {
...
function removePortion(element) {
    ...
    const selectElement = document.getElementById(`portionSelect-${containerIndex}`);
